...
public class MainActivity extends TabActivity implements OnClickListener {
	...
	private void prepareIntent() {
		mHomeItent = new Intent(this, GridActivity.class);
		mChannelIntent = new Intent(this, CourseActivity.class);
		mSearchIntent = new Intent(this, ThirdActivity.class);
		mAccountIntent = new Intent(this, ScoreActivity.class);
